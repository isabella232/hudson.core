 ...
 *
 * <p> {@link Project} and {@link Build} recognizes {@link Action}s that derive
 * from this, and displays it nicely (regardless of the underlying
 * implementation.)
 *
...
public abstract class AbstractTestResultAction<T extends AbstractTestResultAction> implements HealthReportingAction {
    ...
    /**
     * Returns the object that represents the actual test result. This method is
     * used by the remote API so that the XML/JSON that we are sending won't
     * contain unnecessary indirection (that is,
     * {@link AbstractTestResultAction} in between.
     *
     * <p> If such a concept doesn't make sense for a particular subtype, return
     * <tt>this</tt>.
     */
    ...
    /**
     * {@link TestObject}s do not have their own persistence mechanism, so
     * updatable data of {@link TestObject}s need to be persisted by the owning
     * {@link AbstractTestResultAction}, and this method and
     * {@link #setDescription(TestObject, String)} provides that logic.
     *
     * <p> The default implementation stores information in the 'this' object.
     *
